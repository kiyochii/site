  ...
  return (
    <>
      <main>
        <p>
          <div>
            <h2 className="me" style={{ color: color }} onClick={changeColor}>
              kiyochi
            </h2>
            <main className="me2" style={{ color: color }}>
              dan kiyochi shoji
            </main>
          </div>
      ...
      <footer>
        <a
          href="https://github.com/kiyochii"
          target="_blank"
        ...
        <a
          href="https://instagram.com/dankiyochi"
          target="_blank"
          rel="noopener noreferrer"
        >
